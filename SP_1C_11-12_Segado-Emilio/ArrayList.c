...
{
    int returnAux = -1, flag;

    if(this!=NULL)
    {
        flag=resizeDown(this);
...
ArrayList* al_subList(ArrayList* this,int from,int to)
{
    ...
    if(this!=NULL && from >= 0 && from < this->size && from < to)
    {
        returnAux = al_newArrayList();
        for(i=from; i<to; i++)
        {
...
int al_containsAll(ArrayList* this,ArrayList* this2)
{
    ...
    if(this!=NULL && this2!=NULL)
    {
        ...
        {
            auxElement=al_get(this2,i);

            if(al_contains(this,auxElement)==0)
            {
                returnAux=0;
            }
        }
...
void al_swap(ArrayList* this, int a, int b)
{
    void* auxSwap;
    auxSwap = *(this->pElements+a);
    *(this->pElements+a) = *(this->pElements+b);
    *(this->pElements+b) = auxSwap;
}
        ...
        for(i=0; i<(this->size-1); i++)
        {
            for(j=i+1; j<this->size; j++)
            {
                if(order==1)
                {
                    ...
                    {
                        auxVoid = *(this->pElements+i);
                        *(this->pElements+i) = *(this->pElements+j);
                        *(this->pElements+j) = auxVoid;
                    }
                }
                else
                {
...
int resizeDown(ArrayList* this)
{
    ...
    if(this!=NULL)
    {
        auxLista= (void**) realloc(this->pElements, sizeof(void*)*AL_INITIAL_VALUE);
